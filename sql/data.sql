...
(
    ...
    `create_by`          char(19) null default null comment '创建人',
    `update_time`        datetime null default null comment '修改时间',
    `update_by`          char(19) null default null comment '修改人',
...
(
    ...
    price         varchar(16) null comment '设备价格',
...
(
    ...
    price         varchar(16) null comment '产品售价',
    `create_time` datetime null default null comment '创建时间',
    `create_by`   char(19) null default null comment '创建人',
    `update_time` datetime null default null comment '修改时间',
    `update_by`   char(19) null default null comment '修改人',
...
(
    ...
    product_id    char(19) null comment '产品编号',
    `create_time` datetime null default null comment '创建时间',
    `create_by`   char(19) null default null comment '创建人',
    `update_time` datetime null default null comment '修改时间',
    `update_by`   char(19) null default null comment '修改人',
...
(
    ...
    product_id    char(19) null comment '投诉产品编号',
    `create_time` datetime null default null comment '创建时间',
    `create_by`   char(19) null default null comment '创建人',
    `update_time` datetime null default null comment '修改时间',
    `update_by`   char(19) null default null comment '修改人',
...
(
    ...
    price         varchar(16) null comment '价格',
    `time`        datetime null comment '时间',
    `create_time` datetime null default null comment '创建时间',
    `create_by`   char(19) null default null comment '创建人',
    `update_time` datetime null default null comment '修改时间',
...
(
    ...
    bacterial_room_id char(19) null comment '菌房编号',
    `create_time`     datetime null default null comment '创建时间',
    `create_by`       char(19) null default null comment '创建人',
    `update_time`     datetime null default null comment '修改时间',
    `update_by`       char(19) null default null comment '修改人',
...
(
    ...
    location      varchar(128) null comment '菌房位置',
    `create_time` datetime null default null comment '创建时间',
    `create_by`   char(19) null default null comment '创建人',
    `update_time` datetime null default null comment '修改时间',
    `update_by`   char(19) null default null comment '修改人',
...
(
    id              char(19) comment '编号',
    temperature     varchar(16) null comment '空气温度 (摄氏度)',
    humidity        varchar(16) null comment '空气湿度 (%)',
    illumination    varchar(16) null comment '光照 (lux)',
    `time`          datetime null comment '时间',
    carbon_dioxide  varchar(16) null comment '二氧化碳浓度 (ppm)',
    carbon_monoxide varchar(16) null comment '一氧化碳浓度 (ppm)',
    `create_time`   datetime null default null comment '创建时间',
    `create_by`     char(19) null default null comment '创建人',
    `update_time`   datetime null default null comment '修改时间',
    `update_by`     char(19) null default null comment '修改人',
...
(
    ...
    temperature   varchar(16) null comment '空气温度 (摄氏度)',
    humidity      varchar(16) null comment '空气湿度 (%)',
    ph            varchar(16) null comment 'PH值',
    `time`        datetime null comment '时间',
    `create_time` datetime null default null comment '创建时间',
    `create_by`   char(19) null default null comment '创建人',
    `update_time` datetime null default null comment '修改时间',
